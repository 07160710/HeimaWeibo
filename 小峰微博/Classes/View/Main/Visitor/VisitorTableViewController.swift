...
class VisitorTableViewController: UITableViewController {
    ...
    public var userLogin=UserAccountViewModel.sharedUserAccount.userLogin  // 新改
    ...
    public func setupVisitorView()
    {
        ...
        //view.backgroundColor=UIColor.brown//.orange
...
extension VisitorTableViewController{
    ...
    public func visitorViewDidLogin()
    {
        ...
        //presentedViewController(nav,animated: true, completion: nil)
    }
}
